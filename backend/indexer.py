...
class SearchIndex:
    def __init__(self):
        ...
        self.is_built = False
        # For fuzzy matching: store all unique words found
        self.all_words = set()
    ...
    def expand_query(self, query_words):
        """
        Expand query words to include partial matches.
        e.g. 'dict' will match 'dictionary', 'dictate', etc.
        """
        expanded = set(query_words)
        
        for query_word in query_words:
            # Find words in our vocabulary that contain this query word
    ...
    def build_index(self):
        ...
        self.all_words = set(unique_terms)  # Store for fuzzy matching
